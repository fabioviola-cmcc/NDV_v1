    ...
    if 'historical' in run_input:
        ...
        if subpath_output == "":
            ...
            if os.path.exists(os.path.join(path_output, f'{current_time[0:9]}{subpath_output}/')):
                ...
                overwrite = input("Overwrite directory? Yes or No\n")
                if overwrite == 'Yes' or overwrite == 'Y' or overwrite == 'yes' or overwrite == 'y':
                ...
                elif overwrite == 'No' or overwrite == 'N' or overwrite == 'no' or overwrite == 'n':
        ...
        if var_input_new != []:
            ...
            if timei_this == '199201' or timei_this == '199202' or timei_this == '199203':
                path_input_this = path_input[run_input.index("historical")]+run_input[run_input.index("historical")]+'/'+freq_input+'/'+timei_this[0:4]+'/'+timei_this[4:6]+'_spinup/'
            else:
            ...
            for t in time_list[1:]:
                ...
                if t == '199201' or t == '199202' or t == '199203':
                    path_input_this = path_input[run_input.index("historical")]+run_input[run_input.index("historical")]+'/'+freq_input+'/'+t[0:4]+'/'+t[4:6]+'_spinup/'
                else:
            ...
            for var in var_input_new:
                if var == "SurfVel":
                    ...
                    ds_U_historical['SurfVel'] = np.sqrt(ds_U_historical_interp['vozocrtx'].isel(depthu=0)**2 + ds_V_historical_interp['vomecrty'].isel(depthv=0)**2)
                ...
                if var == "T_VertInt":
                    ...
                    ds_T_historical['T_VertInt'] = ds_T_historical['votemper'].integrate("deptht")
    ...
    if 'projection' in run_input:
        ...
        if var_input_new != []:
            ...
            if timei_this == '202201' or timei_this == '202202' or timei_this == '202203':
                path_input_this = path_input[run_input.index("projection")]+run_input[run_input.index("projection")]+'/'+freq_input+'/'+timei_this[0:4]+'/'+timei_this[4:6]+'_spinup/'
            else:
            ...
            for t in time_list[1:]:
                ...
                if t == '202201' or t == '202202' or t == '202203':
                    path_input_this = path_input[run_input.index("projection")]+run_input[run_input.index("projection")]+'/'+freq_input+'/'+t[0:4]+'/'+t[4:6]+'_spinup/'
                else:
            ...
            for var in var_input_new:
                if var == "SurfVel":
                    ...
                    ds_U_projection['SurfVel'] = np.sqrt(ds_U_projection_interp['vozocrtx'].isel(depthu=0)**2 + ds_V_projection_interp['vomecrty'].isel(depthv=0)**2)
                ...
                if var == "T_VertInt":
                    # Calculate Vertically-Integrated Temperature and add it to respective Dataset
                    ds_T_projection['T_VertInt'] = ds_T_projection['votemper'].integrate("deptht")
    ...
    if 'reanalysis' in run_input:
        ...
        if var_input_new != []:    
            ...
            if 'historical' in run_input or 'projection' in run_input:
                ...
                ds_cmems_this_interp.to_netcdf(f'{path_file}reanalysis_interp_{timei}-{timef}_{area_input[0]}N-{area_input[1]}N_{area_input[2]}E-{area_input[3]}E.nc', mode = mode_cmems_interp)
            # Save NetCDF file
...
def plot_dailytimeseries(path_mask, file_mask, var_list2, var_list2_cmems, var_long, run_input, grid_input, var_input, area_input, path_output_this, timei, timef, cbar_title, path_file):
    ...
    if not os.path.exists(os.path.join(path_output_this, 'timeseries/')):
    ...
    for i in range(0,len(var_input)):
        ...
        if len(run_input)==1:
            ...
            ax.set_title(f'Daily mean {var_long[i]} ({area_input[0]}°N-{area_input[1]}°N, {area_input[2]}°E-{area_input[3]}°E) \n '
                         ...
                         f'Var = {var_this}, '
                         f'({run_input})')
            plt.savefig(f'{path_output_this}timeseries/{var_input[i]}_dailymean_{run_input}_{timei_this}-{timef_this}_{area_input[0]}N-{area_input[1]}N_{area_input[2]}E-{area_input[3]}E.png')
            plt.close(fig)
        ...
        if len(run_input)==2:
            ...
            plt.plot(time_this_1, da_1[:], color='darkred', linewidth=1.5)
            plt.plot(time_this_2, da_2[:], color='steelblue', linewidth=1.5)
            ax.set_ylabel(cbar_title[i])
            ax.set_xlabel('Time')
            ...
            fig.text(0.55, 0.85, f'Mean = {mean_this[0]}, Std = {std_this[0]}, ({run_input[0]})', ha="center", va="bottom", size="medium", color="darkred")
            fig.text(0.55, 0.80, f'Mean = {mean_this[1]}, Std = {std_this[1]}, ({run_input[1]})', ha="center", va="bottom", size="medium",color="steelblue")
    ...
    for i in range(0,len(var_input)):
        ...
        if len(run_input)==1:
            ...
            ax.set_title(f'Monthly mean {var_long[i]} ({area_input[0]}°N-{area_input[1]}°N, {area_input[2]}°E-{area_input[3]}°E) \n '
                         ...
                         f'Var = {var_this}, '
                         f'({run_input})')
            plt.savefig(f'{path_output_this}timeseries/{var_input[i]}_monthlymean_{run_input}_{timei_this}-{timef_this}_{area_input[0]}N-{area_input[1]}N_{area_input[2]}E-{area_input[3]}E.png')
            plt.close(fig)
    ...
    for i in range(0,len(var_input)):
        ...
        if len(run_input)==1:
            ...
            ax.set_title(f'Annual mean {var_long[i]} ({area_input[0]}°N-{area_input[1]}°N, {area_input[2]}°E-{area_input[3]}°E) \n '
                         ...
                         f'Var = {var_this}, '
                         f'({run_input})')
            plt.savefig(f'{path_output_this}timeseries/{var_input[i]}_annualmean_{run_input}_{timei_this}-{timef_this}_{area_input[0]}N-{area_input[1]}N_{area_input[2]}E-{area_input[3]}E.png')
            plt.close(fig)
...
def plot_meanmaps(var_list2, var_list2_cmems, var_long, run_input, grid_input, var_input, area_input, path_output_this, timei, timef, cbar_title, cmap_list, path_file):
    # Create output directory
    if not os.path.exists(os.path.join(path_output_this, 'maps/')):
    ...
    for i in range(0,len(var_input)):
        ...
        if len(run_input)==1:
            ...
            plt.savefig(f'{path_output_this}maps/{var_input[i]}_mean_{run_input}_{timei_this}-{timef_this}_{area_input[0]}N-{area_input[1]}N_{area_input[2]}E-{area_input[3]}E.png')
            plt.close(fig)
        ...
        if len(run_input)==2:
            ...
            if 'da_1_interp' in locals():
                da_diff = da_1_interp[:].data - da_2[:].data
            elif 'da_2_interp' in locals():
                da_diff = da_1[:].data - da_2_interp[:].data
            else:
                da_diff = da_1[:].data - da_2[:].data
            ...
            fig.suptitle(f'Mean {var_long[i]} ({timei_this[4:6]}-{timei_this[0:4]} to {timef_this[4:6]}-{timef_this[0:4]})')
    ...
    for i in range(0,len(var_input)):
        ...
        if len(run_input)==1:
            ...
            for mo in range(0,len(da_month)):
                ...
                cbar=plt.colorbar(im)
                cbar.set_label(cbar_title[i])
                plt.savefig(f'{path_output_this}maps/{var_input[i]}_{da_month_str[mo]}_mean_{run_input}_{timei_this}-{timef_this}_{area_input[0]}N-{area_input[1]}N_{area_input[2]}E-{area_input[3]}E.png')
                plt.close(fig)
        ...
        if len(run_input)==2:
            ...
            for mo in range(0,len(da_1_month)):
                ...
                if 'da_1_interp_this' in locals():
                    da_diff = da_1_interp_this - da_2_this
                elif 'da_2_interp_this' in locals():
                    da_diff = da_1_this - da_2_interp_this
                else:
                    da_diff = da_1_this - da_2_this
                ...
                fig.suptitle(f'{da_1_month_str[mo]} Mean {var_long[i]} ({timei_this[4:6]}-{timei_this[0:4]} to {timef_this[4:6]}-{timef_this[0:4]})')
                ...
                plt.savefig(f'{path_output_this}maps/{var_input[i]}_{da_1_month_str[mo]}_mean_{run_input[0]}_{run_input[1]}_{timei_this}-{timef_this}_{area_input[0]}N-{area_input[1]}N_{area_input[2]}E-{area_input[3]}E.png')
                plt.close(fig)
    ...
    for i in range(0,len(var_input)):
        ...
        if len(run_input)==2:
            ...
            for mo in range(0,len(da_1_season)):
                ...
                fig.suptitle(f'{da_1_season_str[mo]} Mean {var_long[i]} ({timei_this[4:6]}-{timei_this[0:4]} to {timef_this[4:6]}-{timef_this[0:4]})')
                ...
                plt.savefig(f'{path_output_this}maps/{var_input[i]}_{da_1_season_str[mo]}_mean_{run_input[0]}_{run_input[1]}_{timei_this}-{timef_this}_{area_input[0]}N-{area_input[1]}N_{area_input[2]}E-{area_input[3]}E.png')
                plt.close(fig)
    ...
    for i in range(0,len(var_input)):
        ...
        if len(run_input)==1:
            ...
            ax.set_title(f'Monthly mean-year {var_long[i]} ({area_input[0]}°N-{area_input[1]}°N, {area_input[2]}°E-{area_input[3]}°E) \n '
                         ...
                         f'Var = {var_this}, '
                         f'({run_input})')
            plt.savefig(f'{path_output_this}timeseries/{var_input[i]}_meanyearmonthly_{run_input}_{timei_this}-{timef_this}_{area_input[0]}N-{area_input[1]}N_{area_input[2]}E-{area_input[3]}E.png')
            plt.close(fig)
        ...
        if len(run_input)==2:
            ...
            fig.set_size_inches(8, 4)
            ax = fig.add_axes([0.1,0.24,0.87,0.54])
            plt.plot(da_1[:], color='darkred', linewidth=1.5)
            plt.plot(da_2[:], color='steelblue', linewidth=1.5)
            ax.set_ylabel(cbar_title[i])
            ax.set_xlabel('Day of Year')
            mean_this = [str(np.round(np.nanmean(da_1),2)),str(np.round(np.nanmean(da_2),2))]
            std_this = [str(np.round(np.nanstd(da_1),2)),str(np.round(np.nanstd(da_2),2))]
            ...
            fig.set_size_inches(8, 4)
            ax = fig.add_axes([0.1,0.24,0.87,0.54])
            plt.plot(da2_1[:], color='darkred', linewidth=1.5)
            plt.plot(da2_2[:], color='steelblue', linewidth=1.5)
            ax.set_ylabel(cbar_title[i])
            ax.set_xlabel('Month')
            ...
            var_this = [str(np.round(np.nanvar(da_1),2)),str(np.round(np.nanvar(da2_2),2))]
            ...
            fig.text(0.55, 0.90, f'Corr = {corr_this}, Bias = {bias_this}, RMSE = {rmse_this}', ha="center", va="bottom", size="medium", color="black")        
            fig.text(0.55, 0.85, f'Mean = {mean_this[0]}, Std = {std_this[0]}, Var = {var_this[0]}, ({run_input[0]})', ha="center", va="bottom", size="medium", color="darkred")
            fig.text(0.55, 0.80, f'Mean = {mean_this[1]}, Std = {std_this[1]}, Var = {var_this[1]}, ({run_input[1]})', ha="center", va="bottom", size="medium",color="steelblue")
...
def save_input(path_output_this):
    os.system('cp ndv_input_inprogress.py ' + os.path.join(path_output_this,'ndv_input_inprogress.py'))
